...
criteria = nn.ClassNLLCriterion(torch.Tensor({0.3,0.3,0.4}))--(torch.Tensor({1,1,1}))
criteria:cuda()
--criterion = nn.ParallelCriterion():add(criteria,1):add(criteria,1e-7):add(criteria,1e-14)
