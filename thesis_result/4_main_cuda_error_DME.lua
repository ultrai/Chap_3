...
for temp =1,21 do
matio.save(paths.cwd() .. '/grads_DME/grad_' .. Idx .. '_' .. temp .. '.mat', Grad[lis[temp]])
oo,n = torch.max(Grad[lis[temp]],1)
matio.save(paths.cwd() .. '/grads_DME/resp_' .. Idx .. '_' .. temp .. '.mat', Responses[temp][1][n[1]])
matio.save(paths.cwd() .. '/grads_DME/Resp_' .. Idx .. '_' .. temp .. '.mat', Responses[temp][1])
end

matio.save(paths.cwd() .. '/grads_DME/image_' .. Idx .. '.mat',test_image[ind[1]])
