...
--for lay = 40,33,-1 do --32
--model:remove(lay)
--end
model = torch.load('vgg.t7')
model:add(nn.View(25088)):add(nn.Linear(25088, 4096)):add(cudnn.ReLU(true)):add(nn.Dropout(0.500000)):add(nn.Linear(4096, 4096)):add(cudnn.ReLU(true)):add(nn.Dropout(0.500000)):add(nn.Linear(4096, 3)):add(cudnn.LogSoftMax())
model:cuda()
